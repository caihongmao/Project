from models.gaze_fc import *
from utils.gazemap import *
from trainers.elg_trainer_gaze import *
...
# 模型
net = GazeFC()
net.load_state_dict(torch.load('models/gaze/model-gaze-0.3-epoch-42-loss-16.1993.pth'))
batch_size = 128
...
# 训练
trainer = elg_gaze_trainer(net, train_dataloader, val_dataloader, 
                     device=device, 
                     batch_size=batch_size, 
                     version = '0.3',
