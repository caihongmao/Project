...
from trainers.dpg_hm_trainer_18_double_person import *
import matplotlib.pyplot as plt
from torch.utils.data import DataLoader, random_split
from datasources.unityeyes import *
from datasources.columbia_gaze_double_person import *
...
# 原始模型
net =  DPGHM18Double()
net.load_state_dict(torch.load('models/dpghm18double/model-dpghm18double-doubel_linear-epoch-2-loss-0.5244.pth'))
